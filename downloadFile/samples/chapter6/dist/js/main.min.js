...
/* main.js */
function imageSlide(e,t){function n(){l||(l=setTimeout(function(){l=null,r.style.position="relative",r.style.left=(window.innerWidth-m[0].clientWidth)/2+"px",p=Flipsnap(r,{distance:m[0].clientWidth,maxPoint:v,duration:u}),p.moveToPoint(s,0),p.element.addEventListener("fspointmove",i),Array.prototype.slice.call(d).forEach(function(e,t){e.addEventListener("click",function(e){p.moveToPoint(t-s)},!1)})},66))}function i(e){p.currentPoint>p.maxPoint-1?o(!0):p.currentPoint<s?o():c(p.currentPoint-s)}function o(e){var t,n;e?(t=p.maxPoint,n=s):(t=1,n=p.maxPoint-1),p.element.removeEventListener("fspointmove",i),p.moveToPoint(t),timer=setTimeout(function(){p.moveToPoint(n,0),c(n-s),p.element.addEventListener("fspointmove",i),clearTimeout(timer)},u+3)}function a(e,t){var n=document.createDocumentFragment(),i=e.length;return _.range(i+2*t).forEach(function(t,o){var a=(o%i+1)%i;n.appendChild(e[a].cloneNode(!0))}),n}function c(e){Array.prototype.slice.call(d).forEach(function(t,n){n!==e||t.className.match("isActive")?n!==e&&t.className.match("isActive")&&(t.className=t.className.replace(" isActive","")):t.className+=" isActive"})}var l=null,s=t.extra||2,r=document.getElementById(e),m=document.getElementsByClassName(t.itemClassName||"js-slide-item"),d=document.getElementsByClassName(t.pointClassName||"js-slide-point"),u=t.duration||350,v=m.length+s,p=null;if(m.length<2)return m[0].style.margin="0 auto",void Array.prototype.slice.call(d).map(function(e,t){e.style.display="none"});var f=a(m,s);r.innerHTML="",r.appendChild(f),n(),window.addEventListener("resize",n,!1)}!function(){function e(e,t,n){var i=" "+t;return function(n){e.className.indexOf(t)>-1?e.className=e.className.replace(i,""):e.className+=i}}var t=document.getElementById("menu-button"),n=document.getElementById("wrapper"),i=document.getElementById("overlay"),o=e(n,"isOpened");t.addEventListener("click",o,!1),i.addEventListener("click",o,!1)}();